...
status_text: "PR #55 open — prototype adds step 7 to start.md (permission-gated skill offer). Skill content is the existing site/public/skill.md (what `nub agent skill` prints). Colin reviews wording + placement before merge."
---
