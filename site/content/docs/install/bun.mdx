...
<CompatTable
  ...
  rows={[
    ...
    { feature: <><code>scripts</code> + lifecycle</>, status: 'yes' },
    // ── Workspaces ────────────────────────────────────────────────────
    ...
    { feature: <>workspace selectors</>, status: 'yes' },
    // ── Config files ──────────────────────────────────────────────────
    { feature: <code>.npmrc</code>, status: 'yes' },
    { feature: <code>bunfig.toml</code>, status: 'yes' },
    // ── Environment variables ─────────────────────────────────────────
    { feature: <><code>npm_config_*</code></>, status: 'yes' },
    { feature: <><code>BUN_CONFIG_REGISTRY</code> / <code>BUN_CONFIG_TOKEN</code></>, status: 'yes' },
    { feature: <>wider <code>BUN_CONFIG_*</code> family</>, status: 'yes' },
    // ── Lockfiles ─────────────────────────────────────────────────────
    ...
    { feature: <>npm / pnpm lockfile round-trip</>, status: 'yes' },
    // ── Install behavior ──────────────────────────────────────────────
    { feature: <><code>linker = "hoisted"</code></>, status: 'yes' },
    { feature: <><code>linker = "isolated"</code></>, status: 'yes' },
    { feature: <>content-addressed store</>, status: 'yes' },
    { feature: <>default-trust floor over <code>bun.lock</code></>, status: 'yes' },
  ]}
/>
