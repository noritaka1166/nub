...
<CompatTable
  ...
  rows={[
    ...
    { feature: <><code>pnpm_config_*</code> / <code>PNPM_CONFIG_*</code></>, status: 'yes' },
    // ── Lockfiles ─────────────────────────────────────────────────────
    { feature: <><code>pnpm-lock.yaml</code> v9</>, status: 'yes' },
    { feature: <>older lockfile versions</>, status: 'yes', note: 'Nub targets v9; v6 (pnpm 8) and v5.4 (pnpm 7) are declined cleanly. Re-lock under pnpm 9+ first.' },
    { feature: <>npm / Bun lockfile round-trip</>, status: 'yes' },
    // ── Linking / hoisting ────────────────────────────────────────────
    { feature: <code>nodeLinker: isolated</code>, status: 'yes' },
