---
title: pnpm
description: pnpm is the package manager Nub mirrors most closely — native version-9 lockfile read and write, an isolated dependency tree, and pnpm's hook file, all gated on pnpm being the incumbent.
---
