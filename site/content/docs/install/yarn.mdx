...
<CompatTable
  ...
  rows={[
    ...
    { feature: <code>.yarnrc.yml</code>, status: 'yes' },
    { feature: <code>.yarnrc</code>, status: 'yes' },
    // ── Environment variables ─────────────────────────────────────────
    { feature: <><code>npm_config_*</code></>, status: 'yes' },
    { feature: <><code>YARN_*</code> config env</>, status: 'yes' },
    // ── Lockfiles ─────────────────────────────────────────────────────
    { feature: <><code>yarn.lock</code></>, status: 'yes' },
    { feature: <>npm / Bun lockfile round-trip</>, status: 'yes' },
    // ── Linking / install behavior ────────────────────────────────────
    { feature: <code>nodeLinker: node-modules</code>, status: 'yes' },
    { feature: <code>nodeLinker: pnpm</code>, status: 'yes' },
    ...
    { feature: <code>supportedArchitectures</code>, status: 'yes' },
  ]}
/>
