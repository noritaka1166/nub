...
<PmSupport
  rows={[
      ...
      items: [
        {
          ...
          ok: true,
          note: 'Read and written in npm-incumbent projects, in lockfileVersion 2/3 format. A lockfileVersion 1 file errors — re-run npm to upgrade it to v2/v3 first.',
        },
    ...
    },
    {
      ...
      items: [
        { code: 'pnpm-lock.yaml', ok: true, note: 'Read and written in pnpm-incumbent projects, in pnpm’s native v9 format.' },
        ...
        { code: 'workspaces', ok: true },
        { code: 'dependenciesMeta.injected', ok: false, note: 'The injected-dependency hard-link layout is out of scope; Nub links the standard isolated tree.' },
    ...
    },
    {
      ...
      items: [
        ...
        { code: 'workspaces', ok: true },
        {
          ...
          ok: true,
          partial: true,
          note: 'Only two of the BUN_CONFIG_* install env vars are read: BUN_CONFIG_REGISTRY (must be an http(s) URL) and BUN_CONFIG_TOKEN. The rest of the BUN_CONFIG_* family is not read.',
        },
        { code: 'engines / os / cpu', ok: true },
      ],
    },
