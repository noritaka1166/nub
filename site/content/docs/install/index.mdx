  ...
  rows={[
    ...
    },
    {
      ...
      items: [
        ...
        { code: '.yarnrc (registry, auth)', ok: true, partial: true },
        { code: 'YARN_* (registry, auth, linker)', ok: true, partial: true },
        { code: '.npmrc', ok: true },
        { code: 'resolutions', ok: true },
        { code: 'workspace:', ok: true },
        { code: 'workspaces', ok: true },
    ...
    },
    {
      ...
      items: [
        ...
        { code: 'workspace:', ok: true },
        { code: 'workspaces', ok: true },
        { code: 'BUN_CONFIG_REGISTRY / _TOKEN', ok: true, partial: true },
        { code: 'engines / os / cpu', ok: true },
      ],
    },
    {
