  ...
  rows={[
    {
      pm: 'npm',
      items: [
        { code: 'package-lock.json (v2/v3)', ok: true },
    ...
    },
    {
      pm: 'pnpm',
      items: [
        { code: 'pnpm-lock.yaml (v9)', ok: true },
        ...
        { code: 'workspaces', ok: true },
        { code: 'dependenciesMeta.injected', ok: false },
        { code: 'nodeLinker: pnp', ok: false },
        { code: 'engines / os / cpu', ok: true },
        { code: 'pnpm_config_*', ok: true },
        { code: 'npm_config_*', ok: true },
      ],
    },
    {
      pm: 'Yarn',
      items: [
        { code: 'yarn.lock (read-only)', ok: true, partial: true },
        { code: '.yarnrc.yml (registry, auth, linker)', ok: true, partial: true },
        { code: '.yarnrc', ok: false },
        { code: '.npmrc', ok: true },
        { code: 'resolutions', ok: true },
        { code: 'workspace:', ok: true },
        { code: 'workspaces', ok: true },
    ...
    },
    {
      ...
      items: [
        ...
        { code: 'bun.lockb', ok: false },
        { code: 'bunfig.toml (registry, scopes, linker)', ok: true, partial: true },
        { code: '.npmrc', ok: true },
