...
<CompatTable
  ...
  rows={[
    ...
    // ── Lockfiles ─────────────────────────────────────────────────────
    { feature: <><code>package-lock.json</code> v3</>, status: 'yes' },
    { feature: <><code>package-lock.json</code> v2</>, status: 'yes' },
    ...
    { feature: <>pnpm / Bun lockfile round-trip</>, status: 'yes' },
    // ── Install behavior ──────────────────────────────────────────────
    { feature: <>hoisted <code>node_modules</code></>, status: 'yes' },
    { feature: <>lifecycle build scripts</>, status: 'yes' },
