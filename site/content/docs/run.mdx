---
title: Script runner
description: A drop-in for npm run and pnpm run — lifecycle hooks, the standard npm environment variables, arg forwarding, and pnpm-style workspace filters, roughly 7× faster on the cold path.
---
