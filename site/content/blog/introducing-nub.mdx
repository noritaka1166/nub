...
Nub ships a full package manager, powered by the embedded [aube](https://github.com/jdx/aube) engine — built in partnership with [jdx](https://github.com/jdx). The CLI surface is pnpm's; the lockfile is whatever your project already uses:
