...
<Bench
  label="echo noop · pure shell · 100 runs"
  source="https://github.com/nubjs/nub/tree/main/benchmarks"
  accent="acid"
  max={356}
  rows={[
...
The benchmarked script is identical on every row — the delta is pure wrapper overhead. Methodology: 3 warmup runs, 100 timed runs, Apple M1 Max, Node 24.14.0 — the numbers are machine-specific, the ratios are the portable claim. Reproduce with [`benchmarks/`](https://github.com/nubjs/nub/tree/main/benchmarks).
...
<Bench
  ...
  max={4732}
  rows={[
    { cmd: 'nub', ms: 974, us: true },
    { cmd: 'bun', ms: 1498, ratio: 1.54 },
    { cmd: 'pnpm', ms: 2743, ratio: 2.82 },
    { cmd: 'npm', ms: 4732, ratio: 4.86 },
  ]}
/>
