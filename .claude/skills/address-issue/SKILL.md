...
- **Tone is always factual, neutral, professional — never braggy, competitive, or over-promising.** Every comment follows the project's tone bar (AGENTS.md "The repo is PUBLIC" + the commit-message tone rule). Acknowledge sincerely; state what you found and what you did; don't promise a timeline you can't keep.
